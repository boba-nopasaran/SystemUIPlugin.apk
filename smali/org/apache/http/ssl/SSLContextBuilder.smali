...
.method public build()Ljavax/net/ssl/SSLContext;
    ...
    iget-object v2, p0, Lorg/apache/http/ssl/SSLContextBuilder;->protocol:Ljava/lang/String;
    ...
    :goto_0
    iget-object v2, p0, Lorg/apache/http/ssl/SSLContextBuilder;->provider:Ljava/security/Provider;
    ...
    :goto_1
    iget-object v2, p0, Lorg/apache/http/ssl/SSLContextBuilder;->keyManagers:Ljava/util/Set;

    iget-object v3, p0, Lorg/apache/http/ssl/SSLContextBuilder;->trustManagers:Ljava/util/Set;

    iget-object v4, p0, Lorg/apache/http/ssl/SSLContextBuilder;->secureRandom:Ljava/security/SecureRandom;

    invoke-virtual {p0, v1, v2, v3, v4}, Lorg/apache/http/ssl/SSLContextBuilder;->initSSLContext(Ljavax/net/ssl/SSLContext;Ljava/util/Collection;Ljava/util/Collection;Ljava/security/SecureRandom;)V
...
.method public loadKeyMaterial(Ljava/io/File;[C[CLorg/apache/http/ssl/PrivateKeyStrategy;)Lorg/apache/http/ssl/SSLContextBuilder;
    ...
    iget-object v2, p0, Lorg/apache/http/ssl/SSLContextBuilder;->keyStoreType:Ljava/lang/String;
...
.method public loadKeyMaterial(Ljava/security/KeyStore;[CLorg/apache/http/ssl/PrivateKeyStrategy;)Lorg/apache/http/ssl/SSLContextBuilder;
    ...
    iget-object v7, p0, Lorg/apache/http/ssl/SSLContextBuilder;->keyManagerFactoryAlgorithm:Ljava/lang/String;
...
.method public loadTrustMaterial(Ljava/security/KeyStore;Lorg/apache/http/ssl/TrustStrategy;)Lorg/apache/http/ssl/SSLContextBuilder;
    ...
    iget-object v7, p0, Lorg/apache/http/ssl/SSLContextBuilder;->trustManagerFactoryAlgorithm:Ljava/lang/String;
