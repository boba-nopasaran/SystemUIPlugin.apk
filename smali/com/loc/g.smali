...
.method static constructor <clinit>()V
    ...
    sput-wide v2, Lcom/loc/g;->p:J

    sput-boolean v1, Lcom/loc/g;->s:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    iput-wide v4, p0, Lcom/loc/g;->B:J
    ...
    iput-object v2, p0, Lcom/loc/g;->f:Lcom/loc/by;
    ...
    iput-object v0, p0, Lcom/loc/g;->q:Lcom/amap/api/location/AMapLocationClientOption$GeoLanguage;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/loc/g;->r:Z

    iput-wide v4, p0, Lcom/loc/g;->u:J

    iput v1, p0, Lcom/loc/g;->v:I

    new-instance v0, Lcom/loc/g$1;

    invoke-direct {v0, p0}, Lcom/loc/g$1;-><init>(Lcom/loc/g;)V

    iput-object v0, p0, Lcom/loc/g;->w:Landroid/location/LocationListener;

    iput v1, p0, Lcom/loc/g;->x:I

    iput-object v2, p0, Lcom/loc/g;->y:Landroid/location/GpsStatus;

    new-instance v0, Lcom/loc/g$2;

    invoke-direct {v0, p0}, Lcom/loc/g$2;-><init>(Lcom/loc/g;)V

    iput-object v0, p0, Lcom/loc/g;->D:Landroid/location/GpsStatus$Listener;

    iput-object v2, p0, Lcom/loc/g;->z:Lcom/amap/api/location/AMapLocation;

    iput-object v2, p0, Lcom/loc/g;->E:Ljava/lang/String;

    iput-boolean v1, p0, Lcom/loc/g;->F:Z

    iput v1, p0, Lcom/loc/g;->G:I

    iput-object p1, p0, Lcom/loc/g;->A:Landroid/content/Context;

    iput-object p2, p0, Lcom/loc/g;->a:Landroid/os/Handler;

    iget-object v0, p0, Lcom/loc/g;->A:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/loc/g;->f:Lcom/loc/by;

    return-void
.end method

.method static synthetic a(Lcom/loc/g;)Landroid/content/Context;
    .locals 1
...
.method static synthetic a(Lcom/loc/g;Lcom/amap/api/location/AMapLocation;)V
    .locals 0
...
.method static synthetic a(Lcom/loc/g;Lcom/amap/api/location/AMapLocation;Lcom/amap/api/location/AMapLocation;)V
    .locals 2
    ...
    invoke-static {p1, p2}, Lcom/loc/db;->a(Lcom/amap/api/location/AMapLocation;Lcom/amap/api/location/AMapLocation;)F
    ...
    invoke-static {p1, p2}, Lcom/loc/ct;->a(Lcom/amap/api/location/AMapLocation;Lcom/amap/api/location/AMapLocation;)Lcom/amap/api/location/AMapLocation;
...
.method private static a(Landroid/location/LocationManager;)Z
    ...
    sput-boolean v0, Lcom/loc/g;->s:Z
...
.method private a(Ljava/lang/String;)Z
    ...
    :try_start_0
    invoke-static {p1}, Lcom/loc/db;->e(Ljava/lang/String;)Ljava/util/ArrayList;

    move-result-object v1

    iget-object v2, p0, Lcom/loc/g;->E:Ljava/lang/String;

    invoke-static {v2}, Lcom/loc/db;->e(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lcom/loc/g;->E:Ljava/lang/String;

    invoke-static {v1, p1}, Lcom/loc/db;->a(Ljava/lang/String;Ljava/lang/String;)Z
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method static synthetic b(Lcom/loc/g;)J
    .locals 2

    iget-wide v0, p0, Lcom/loc/g;->B:J
...
.method private b(Lcom/amap/api/location/AMapLocation;)V
    ...
    iget-wide v2, p0, Lcom/loc/g;->u:J
    ...
    iput-wide v0, p0, Lcom/loc/g;->u:J
...
.method static synthetic b(Lcom/loc/g;Lcom/amap/api/location/AMapLocation;)V
    .locals 6
    ...
    invoke-static {v0, v1, v2, v3}, Lcom/loc/ct;->a(DD)Z
    ...
    invoke-static {v0, v1}, Lcom/loc/cu;->a(Landroid/content/Context;Lcom/amap/api/location/DPoint;)Lcom/amap/api/location/DPoint;
...
.method static synthetic c(Lcom/loc/g;)Ljava/lang/String;
    .locals 1

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/loc/g;->E:Ljava/lang/String;
...
.method static synthetic c(Lcom/loc/g;Lcom/amap/api/location/AMapLocation;)V
    .locals 2

    :try_start_0
    iget v0, p0, Lcom/loc/g;->x:I
...
.method static synthetic d(Lcom/loc/g;Lcom/amap/api/location/AMapLocation;)Lcom/amap/api/location/AMapLocation;
    .locals 4
    ...
    :cond_5
    iget-object v0, p0, Lcom/loc/g;->f:Lcom/loc/by;

    invoke-virtual {v0, p1}, Lcom/loc/by;->a(Lcom/amap/api/location/AMapLocation;)Lcom/amap/api/location/AMapLocation;
...
.method static synthetic d(Lcom/loc/g;)Z
    .locals 1

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/loc/g;->F:Z

    return v0
.end method

.method static synthetic e(Lcom/loc/g;)I
    .locals 1
...
.method static synthetic e(Lcom/loc/g;Lcom/amap/api/location/AMapLocation;)V
    .locals 4
    ...
    sget-object v1, Lcom/loc/g;->l:Ljava/lang/Object;
...
.method static synthetic f(Lcom/loc/g;Lcom/amap/api/location/AMapLocation;)V
    .locals 4
    ...
    sget-boolean v0, Lcom/loc/ct;->l:Z
    ...
    invoke-static {v0, v1, v2, v3}, Lcom/loc/da;->b(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    sput-boolean v0, Lcom/loc/ct;->l:Z
    ...
    invoke-static {v0, v1, v2, v3}, Lcom/loc/da;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Z)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final a(Lcom/amap/api/location/AMapLocation;Ljava/lang/String;)Lcom/amap/api/location/AMapLocation;
    ...
    iget-object v2, p0, Lcom/loc/g;->i:Lcom/amap/api/location/AMapLocation;
    ...
    iget v0, p0, Lcom/loc/g;->G:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p0, Lcom/loc/g;->G:I

    iget-object v0, p0, Lcom/loc/g;->E:Ljava/lang/String;
    ...
    iget-boolean v0, p0, Lcom/loc/g;->F:Z
    ...
    iput-boolean v8, p0, Lcom/loc/g;->F:Z

    iput v8, p0, Lcom/loc/g;->G:I
    ...
    :cond_a
    iput-object v12, p0, Lcom/loc/g;->E:Ljava/lang/String;

    iput v8, p0, Lcom/loc/g;->G:I

    iput-object v12, p0, Lcom/loc/g;->i:Lcom/amap/api/location/AMapLocation;
    ...
    iput-object p2, p0, Lcom/loc/g;->E:Ljava/lang/String;
...
.method public final a()V
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lcom/loc/g;->w:Landroid/location/LocationListener;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/loc/g;->b:Landroid/location/LocationManager;

    iget-object v1, p0, Lcom/loc/g;->w:Landroid/location/LocationListener;
    ...
    :goto_1
    :try_start_1
    iget-object v0, p0, Lcom/loc/g;->D:Landroid/location/GpsStatus$Listener;

    if-eqz v0, :cond_2

    iget-object v0, p0, Lcom/loc/g;->b:Landroid/location/LocationManager;

    iget-object v1, p0, Lcom/loc/g;->D:Landroid/location/GpsStatus$Listener;
    ...
    :cond_3
    :goto_3
    iput v4, p0, Lcom/loc/g;->x:I

    iput-wide v2, p0, Lcom/loc/g;->B:J

    iput-wide v2, p0, Lcom/loc/g;->u:J

    iput-wide v2, p0, Lcom/loc/g;->d:J

    iput v4, p0, Lcom/loc/g;->C:I

    iput v4, p0, Lcom/loc/g;->v:I

    iget-object v0, p0, Lcom/loc/g;->f:Lcom/loc/by;

    invoke-virtual {v0}, Lcom/loc/by;->a()V

    iput-object v5, p0, Lcom/loc/g;->i:Lcom/amap/api/location/AMapLocation;
    ...
    iput-object v5, p0, Lcom/loc/g;->E:Ljava/lang/String;
...
.method public final a(Landroid/os/Bundle;)V
    ...
    :try_start_1
    iput-object v0, p0, Lcom/loc/g;->z:Lcom/amap/api/location/AMapLocation;
...
.method final a(Lcom/amap/api/location/AMapLocation;)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/loc/g;->z:Lcom/amap/api/location/AMapLocation;
    ...
    invoke-static {p1, v0}, Lcom/loc/db;->a(Lcom/amap/api/location/AMapLocation;Lcom/amap/api/location/AMapLocation;)F

    move-result v0

    iget v3, p0, Lcom/loc/g;->h:I
...
.method public final a(Lcom/amap/api/location/AMapLocationClientOption;)V
    ...
    sget-wide v4, Lcom/loc/g;->p:J

    invoke-static {v0, v1, v2, v4, v5}, Lcom/loc/da;->b(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;J)J

    move-result-wide v0

    sput-wide v0, Lcom/loc/g;->p:J
    :try_end_0
    ...
    iput-wide v0, p0, Lcom/loc/g;->B:J
    ...
    invoke-static {v0, v1, v2, v4, v5}, Lcom/loc/da;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;J)V
    :try_end_2
    ...
    iget-object v5, p0, Lcom/loc/g;->w:Landroid/location/LocationListener;
    ...
    iput-boolean v1, p0, Lcom/loc/g;->r:Z

    const/16 v1, 0x849

    invoke-static {v8, v1}, Lcom/loc/cy;->a(Ljava/lang/String;I)V
...
.method public final b(Lcom/amap/api/location/AMapLocationClientOption;)V
    ...
    :cond_1
    iget-object v0, p0, Lcom/loc/g;->q:Lcom/amap/api/location/AMapLocationClientOption$GeoLanguage;
...
.method public final d()I
    ...
    :cond_4
    iget-boolean v0, p0, Lcom/loc/g;->r:Z
