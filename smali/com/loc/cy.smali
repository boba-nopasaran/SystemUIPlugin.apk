...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/loc/cy;->h:Ljava/util/List;

    sput-object v1, Lcom/loc/cy;->i:Lorg/json/JSONArray;

    sput-object v1, Lcom/loc/cy;->g:Lcom/amap/api/location/AMapLocation;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/loc/cy;->a:Landroid/util/SparseArray;

    iput v3, p0, Lcom/loc/cy;->b:I

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lcom/loc/cy;->c:J
    ...
    iput v3, p0, Lcom/loc/cy;->e:I

    const-wide/16 v0, -0x1

    iput-wide v0, p0, Lcom/loc/cy;->f:J
...
.method public static a(Landroid/content/Context;)V
    ...
    :cond_1
    sget-object v0, Lcom/loc/cy;->h:Ljava/util/List;
    ...
    sget-object v1, Lcom/loc/cy;->h:Ljava/util/List;

    invoke-interface {v0, v1}, Ljava/util/List;->addAll(Ljava/util/Collection;)Z

    invoke-static {v0, p0}, Lcom/loc/bt;->a(Ljava/util/List;Landroid/content/Context;)V
    ...
    :cond_2
    invoke-static {p0}, Lcom/loc/cy;->f(Landroid/content/Context;)V
    :try_end_0
...
.method public static a(Landroid/content/Context;IIJJ)V
    ...
    invoke-static {p0, v0, v1}, Lcom/loc/cy;->a(Landroid/content/Context;Ljava/lang/String;Lorg/json/JSONObject;)V
    :try_end_1
...
.method public static a(Landroid/content/Context;JZ)V
    ...
    invoke-static/range {v0 .. v5}, Lcom/loc/cy;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;II)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static a(Landroid/content/Context;Lcom/amap/api/location/AMapLocation;)V
    ...
    invoke-static {p1}, Lcom/loc/cy;->a(Lcom/amap/api/location/AMapLocation;)Z
...
.method public static a(Landroid/content/Context;Lcom/loc/cx;)V
    .locals 12
    ...
    :cond_1
    invoke-virtual {p1}, Lcom/loc/cx;->c()Lcom/autonavi/aps/amapapi/model/AMapLocationServer;
    ...
    invoke-virtual {p1}, Lcom/loc/cx;->a()J

    move-result-wide v4

    invoke-virtual {p1}, Lcom/loc/cx;->b()J
    ...
    invoke-static {v3}, Lcom/loc/cy;->a(Lcom/amap/api/location/AMapLocation;)Z
    ...
    invoke-static/range {v6 .. v11}, Lcom/loc/cy;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;II)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static a(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {p0, v0, v1, p1}, Lcom/loc/cy;->a(Landroid/content/Context;Ljava/lang/String;ILjava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static a(Landroid/content/Context;Ljava/lang/String;I)V
    ...
    invoke-static {p0, v0, p2, p1}, Lcom/loc/cy;->a(Landroid/content/Context;Ljava/lang/String;ILjava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method private static a(Landroid/content/Context;Ljava/lang/String;ILjava/lang/String;)V
    ...
    :cond_3
    invoke-static {p0, p1, v0}, Lcom/loc/cy;->a(Landroid/content/Context;Ljava/lang/String;Lorg/json/JSONObject;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method private static a(Landroid/content/Context;Ljava/lang/String;Lorg/json/JSONObject;)V
    ...
    invoke-direct {v0, p0, v1, v2, p1}, Lcom/loc/bs;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public static a(Lcom/amap/api/location/AMapLocation;Lcom/amap/api/location/AMapLocation;)V
    ...
    :try_start_0
    sget-object v0, Lcom/loc/cy;->g:Lcom/amap/api/location/AMapLocation;

    if-nez v0, :cond_2

    invoke-static {p0}, Lcom/loc/db;->a(Lcom/amap/api/location/AMapLocation;)Z

    move-result v0

    if-nez v0, :cond_1

    sput-object p1, Lcom/loc/cy;->g:Lcom/amap/api/location/AMapLocation;
    ...
    sput-object v0, Lcom/loc/cy;->g:Lcom/amap/api/location/AMapLocation;

    :cond_2
    sget-object v0, Lcom/loc/cy;->g:Lcom/amap/api/location/AMapLocation;

    invoke-static {v0}, Lcom/loc/db;->a(Lcom/amap/api/location/AMapLocation;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p1}, Lcom/loc/db;->a(Lcom/amap/api/location/AMapLocation;)Z
    ...
    sget-object v3, Lcom/loc/cy;->g:Lcom/amap/api/location/AMapLocation;
    ...
    invoke-static {v3, v2}, Lcom/loc/db;->a(Lcom/amap/api/location/AMapLocation;Lcom/amap/api/location/AMapLocation;)F
    ...
    sget-object v1, Lcom/loc/cy;->g:Lcom/amap/api/location/AMapLocation;
    ...
    invoke-static {v4, v5, v1}, Lcom/loc/db;->a(JLjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, v3}, Lcom/loc/cy;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_4
    sput-object v2, Lcom/loc/cy;->g:Lcom/amap/api/location/AMapLocation;
...
.method public static a(Ljava/lang/String;I)V
    ...
    :goto_0
    invoke-static {p0, v1, v0}, Lcom/loc/cy;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public static a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, p1, p0}, Lcom/loc/z;->b(Lcom/loc/s;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v1, p2, p0, p1}, Lcom/loc/z;->a(Lcom/loc/s;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static a(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v0, p0, p1}, Lcom/loc/z;->a(Lcom/loc/s;Ljava/lang/String;Lcom/loc/j;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method private static a(Lcom/amap/api/location/AMapLocation;)Z
    ...
    sget-object v3, Lcom/loc/ct;->a:Ljava/lang/String;
...
.method public static b(Landroid/content/Context;Lcom/amap/api/location/AMapLocation;)V
    ...
    sget-object v0, Lcom/loc/cy;->i:Lorg/json/JSONArray;
    ...
    sput-object v0, Lcom/loc/cy;->i:Lorg/json/JSONArray;
    ...
    sget-object v1, Lcom/loc/cy;->i:Lorg/json/JSONArray;
...
.method private static f(Landroid/content/Context;)V
    ...
    sget-object v2, Lcom/loc/cy;->i:Lorg/json/JSONArray;

    invoke-virtual {v2}, Lorg/json/JSONArray;->toString()Ljava/lang/String;

    move-result-object v2

    invoke-direct {v1, p0, v0, v2}, Lcom/loc/bq;-><init>(Landroid/content/Context;Lcom/loc/s;Ljava/lang/String;)V

    invoke-static {v1, p0}, Lcom/loc/br;->a(Lcom/loc/bq;Landroid/content/Context;)V
...
.method public final a(Landroid/content/Context;I)V
    ...
    iget-wide v2, p0, Lcom/loc/cy;->c:J

    sub-long v2, v0, v2

    iget-object v0, p0, Lcom/loc/cy;->a:Landroid/util/SparseArray;

    iget v1, p0, Lcom/loc/cy;->b:I
    ...
    iget-object v4, p0, Lcom/loc/cy;->a:Landroid/util/SparseArray;

    iget v5, p0, Lcom/loc/cy;->b:I
    ...
    iget-object v1, p0, Lcom/loc/cy;->d:[Ljava/lang/String;

    aget-object v1, v1, p2

    const-wide/16 v2, 0x0

    invoke-static {p1, v0, v1, v2, v3}, Lcom/loc/da;->b(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;J)J
...
.method public final a(Landroid/content/Context;Lcom/amap/api/location/AMapLocationClientOption;)V
    ...
    :try_start_0
    sget-object v0, Lcom/loc/cy$1;->a:[I
    ...
    iget-wide v4, p0, Lcom/loc/cy;->f:J

    sub-long/2addr v2, v4

    iget-object v0, p0, Lcom/loc/cy;->a:Landroid/util/SparseArray;

    iget v4, p0, Lcom/loc/cy;->e:I
    ...
    iget-object v2, p0, Lcom/loc/cy;->d:[Ljava/lang/String;

    aget-object v2, v2, v1

    const-wide/16 v4, 0x0

    invoke-static {p1, v0, v2, v4, v5}, Lcom/loc/da;->b(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;J)J
    ...
    iput-wide v2, p0, Lcom/loc/cy;->f:J

    iput v1, p0, Lcom/loc/cy;->e:I
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final b(Landroid/content/Context;)V
    ...
    iget-wide v2, p0, Lcom/loc/cy;->f:J
    ...
    iget-object v4, p0, Lcom/loc/cy;->d:[Ljava/lang/String;

    aget-object v4, v4, v1

    const-wide/16 v6, 0x0

    invoke-static {p1, v0, v4, v6, v7}, Lcom/loc/da;->b(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;J)J
    ...
    invoke-static {p1, v0, v4, v2, v3}, Lcom/loc/da;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;J)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final c(Landroid/content/Context;)I
    ...
    iget-object v5, p0, Lcom/loc/cy;->d:[Ljava/lang/String;
    ...
    invoke-static {p1, v4, v5, v6, v7}, Lcom/loc/da;->b(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;J)J

    move-result-wide v4

    const-string v6, "pref"

    iget-object v7, p0, Lcom/loc/cy;->d:[Ljava/lang/String;
    ...
    invoke-static {p1, v6, v7, v8, v9}, Lcom/loc/da;->b(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;J)J

    move-result-wide v6

    const-string v8, "pref"

    iget-object v9, p0, Lcom/loc/cy;->d:[Ljava/lang/String;
    ...
    invoke-static {p1, v8, v9, v10, v11}, Lcom/loc/da;->b(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;J)J
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final e(Landroid/content/Context;)V
    ...
    invoke-static {p1, v1, v2, v4, v5}, Lcom/loc/da;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;J)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
