...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/maploc/f;->a:Landroid/content/Context;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/maploc/f;->b:Ljava/util/ArrayList;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Lcom/maploc/f;->c:Ljava/lang/Object;

    iput-object v1, p0, Lcom/maploc/f;->d:Landroid/os/Handler;

    iput-object v1, p0, Lcom/maploc/f;->e:Lcom/maploc/f$a;

    iput-object v1, p0, Lcom/maploc/f;->f:Landroid/os/Handler;
    ...
    iput-object v0, p0, Lcom/maploc/f;->g:Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;

    iput-object v1, p0, Lcom/maploc/f;->h:Lcom/maploc/i;
    ...
    iput-object v0, p0, Lcom/maploc/f;->i:Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption$Inner_3dMap_Enum_LocationMode;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/maploc/f;->j:Z
    ...
    iput-object v0, p0, Lcom/maploc/f;->a:Landroid/content/Context;

    invoke-direct {p0}, Lcom/maploc/f;->e()V
...
.method private a(Landroid/os/Looper;)Landroid/os/Handler;
    ...
    iget-object v1, p0, Lcom/maploc/f;->c:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    new-instance v0, Lcom/maploc/g;

    invoke-direct {v0, p1, p0}, Lcom/maploc/g;-><init>(Landroid/os/Looper;Lcom/maploc/f;)V

    iput-object v0, p0, Lcom/maploc/f;->f:Landroid/os/Handler;

    iget-object v0, p0, Lcom/maploc/f;->f:Landroid/os/Handler;
...
.method private a(ILjava/lang/Object;J)V
    ...
    iget-object v2, p0, Lcom/maploc/f;->f:Landroid/os/Handler;
...
.method private e()V
    ...
    new-instance v0, Lcom/maploc/h;

    iget-object v1, p0, Lcom/maploc/f;->a:Landroid/content/Context;

    invoke-virtual {v1}, Landroid/content/Context;->getMainLooper()Landroid/os/Looper;

    move-result-object v1

    invoke-direct {v0, v1, p0}, Lcom/maploc/h;-><init>(Landroid/os/Looper;Lcom/maploc/f;)V

    iput-object v0, p0, Lcom/maploc/f;->d:Landroid/os/Handler;
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0

    :goto_0
    :try_start_1
    new-instance v0, Lcom/maploc/f$a;

    const-string v1, "locaitonClientActionThread"

    invoke-direct {v0, v1, p0}, Lcom/maploc/f$a;-><init>(Ljava/lang/String;Lcom/maploc/f;)V

    iput-object v0, p0, Lcom/maploc/f;->e:Lcom/maploc/f$a;

    iget-object v0, p0, Lcom/maploc/f;->e:Lcom/maploc/f$a;

    const/4 v1, 0x5

    invoke-virtual {v0, v1}, Lcom/maploc/f$a;->setPriority(I)V

    iget-object v0, p0, Lcom/maploc/f;->e:Lcom/maploc/f$a;

    invoke-virtual {v0}, Lcom/maploc/f$a;->start()V

    iget-object v0, p0, Lcom/maploc/f;->e:Lcom/maploc/f$a;

    invoke-virtual {v0}, Lcom/maploc/f$a;->getLooper()Landroid/os/Looper;

    move-result-object v0

    invoke-direct {p0, v0}, Lcom/maploc/f;->a(Landroid/os/Looper;)Landroid/os/Handler;
    ...
    invoke-direct {v0, p0}, Lcom/maploc/h;-><init>(Lcom/maploc/f;)V
...
.method final a()V
    ...
    :try_start_0
    iget-boolean v0, p0, Lcom/maploc/f;->j:Z
    ...
    invoke-direct {p0, v0, v1, v2, v3}, Lcom/maploc/f;->a(ILjava/lang/Object;J)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method final a(Lcom/autonavi/amap/mapcore/Inner_3dMap_location;)V
    ...
    invoke-static {v0, v1}, Lcom/maploc/y;->b(D)D
    ...
    invoke-static {v0}, Lcom/maploc/y;->a(F)F
    ...
    iget-object v0, p0, Lcom/maploc/f;->b:Ljava/util/ArrayList;
    ...
    :cond_1
    :try_start_2
    iget-object v0, p0, Lcom/maploc/f;->g:Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;
    ...
    invoke-virtual {p0}, Lcom/maploc/f;->c()V
    :try_end_2
...
.method final a(Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;)V
    ...
    iput-object p1, p0, Lcom/maploc/f;->g:Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;
    ...
    :cond_0
    iget-object v0, p0, Lcom/maploc/f;->h:Lcom/maploc/i;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/maploc/f;->h:Lcom/maploc/i;

    iget-object v1, p0, Lcom/maploc/f;->g:Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;

    invoke-virtual {v0, v1}, Lcom/maploc/i;->a(Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;)V
    ...
    iget-object v0, p0, Lcom/maploc/f;->i:Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption$Inner_3dMap_Enum_LocationMode;
    ...
    invoke-virtual {p0}, Lcom/maploc/f;->a()V
...
.method final b()V
    ...
    :try_start_0
    iget-object v2, p0, Lcom/maploc/f;->h:Lcom/maploc/i;

    if-eqz v2, :cond_0

    iget-object v2, p0, Lcom/maploc/f;->h:Lcom/maploc/i;

    invoke-virtual {v2}, Lcom/maploc/i;->a()V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :cond_0
    iget-object v2, p0, Lcom/maploc/f;->g:Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;
    ...
    :goto_0
    invoke-direct {p0, v6, v7, v0, v1}, Lcom/maploc/f;->a(ILjava/lang/Object;J)V
    ...
    iget-object v3, p0, Lcom/maploc/f;->g:Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;
...
.method final c()V
    ...
    invoke-direct {p0, v0}, Lcom/maploc/f;->a(I)V
    ...
    invoke-virtual {v0}, Lcom/maploc/i;->c()V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method final d()V
    ...
    invoke-virtual {v0}, Lcom/maploc/i;->d()V

    :cond_0
    invoke-direct {p0}, Lcom/maploc/f;->f()V
    ...
    invoke-virtual {v0}, Lcom/maploc/f$a;->quit()Z
...
.method public setLocationListener(Lcom/autonavi/amap/mapcore/Inner_3dMap_locationListener;)V
    ...
    :try_start_0
    invoke-direct {p0, v0, p1, v2, v3}, Lcom/maploc/f;->a(ILjava/lang/Object;J)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
