...
.field private e:Lcom/amap/api/col/bo;
...
.method static a(Ljava/util/Collection;Lcom/amap/api/col/bo;II)D
    .locals 20
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-wide v8, v0, Lcom/amap/api/col/bo;->a:D

    move-object/from16 v0, p1

    iget-wide v2, v0, Lcom/amap/api/col/bo;->c:D

    move-object/from16 v0, p1

    iget-wide v10, v0, Lcom/amap/api/col/bo;->b:D

    move-object/from16 v0, p1

    iget-wide v4, v0, Lcom/amap/api/col/bo;->d:D
...
.method static a(Ljava/util/Collection;)Lcom/amap/api/col/bo;
    .locals 14
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_4
    new-instance v1, Lcom/amap/api/col/bo;

    invoke-direct/range {v1 .. v9}, Lcom/amap/api/col/bo;-><init>(DDDD)V
...
.method private a(I)[D
    ...
    iget-object v5, p0, Lcom/amap/api/maps/model/HeatmapTileProvider;->e:Lcom/amap/api/col/bo;
    ...
    invoke-static {v1, v5, p1, v6}, Lcom/amap/api/maps/model/HeatmapTileProvider;->a(Ljava/util/Collection;Lcom/amap/api/col/bo;II)D
...
.method private c(Ljava/util/Collection;)V
    ...
    invoke-static {v0}, Lcom/amap/api/maps/model/HeatmapTileProvider;->a(Ljava/util/Collection;)Lcom/amap/api/col/bo;

    move-result-object v0

    iput-object v0, p0, Lcom/amap/api/maps/model/HeatmapTileProvider;->e:Lcom/amap/api/col/bo;

    new-instance v0, Lcom/amap/api/maps/model/a;

    iget-object v1, p0, Lcom/amap/api/maps/model/HeatmapTileProvider;->e:Lcom/amap/api/col/bo;

    invoke-direct {v0, v1}, Lcom/amap/api/maps/model/a;-><init>(Lcom/amap/api/col/bo;)V
...
.method public getTile(III)Lcom/amap/api/maps/model/Tile;
    ...
    invoke-virtual {v2, v3}, Lcom/amap/api/maps/model/a;->a(Lcom/amap/api/col/bo;)Ljava/util/Collection;
    ...
    new-instance v11, Lcom/amap/api/col/bo;

    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/amap/api/maps/model/HeatmapTileProvider;->e:Lcom/amap/api/col/bo;

    iget-wide v4, v2, Lcom/amap/api/col/bo;->a:D
    ...
    iget-wide v4, v2, Lcom/amap/api/col/bo;->c:D
    ...
    iget-wide v4, v2, Lcom/amap/api/col/bo;->b:D
    ...
    iget-wide v4, v2, Lcom/amap/api/col/bo;->d:D

    add-double v18, v18, v4

    invoke-direct/range {v11 .. v19}, Lcom/amap/api/col/bo;-><init>(DDDD)V

    invoke-virtual {v3, v11}, Lcom/amap/api/col/bo;->a(Lcom/amap/api/col/bo;)Z
