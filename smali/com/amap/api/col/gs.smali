...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/amap/api/col/gs;->a:Z
...
.method public static a(Landroid/content/Context;)V
    ...
    :try_start_0
    invoke-static {p0}, Lcom/amap/api/col/gs;->e(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lcom/amap/api/col/gs;->b(Landroid/content/Context;)[B
...
.method public static declared-synchronized a(Lcom/amap/api/col/gr;Landroid/content/Context;)V
    .locals 3

    const-class v1, Lcom/amap/api/col/gs;
    ...
    new-instance v2, Lcom/amap/api/col/gs$1;

    invoke-direct {v2, p1, p0}, Lcom/amap/api/col/gs$1;-><init>(Landroid/content/Context;Lcom/amap/api/col/gr;)V
...
.method private static b(Landroid/content/Context;)[B
    ...
    invoke-static {p0}, Lcom/amap/api/col/gs;->c(Landroid/content/Context;)[B

    move-result-object v0

    invoke-static {p0}, Lcom/amap/api/col/gs;->d(Landroid/content/Context;)[B
    ...
    invoke-static {p0, v2}, Lcom/amap/api/col/gs;->a(Landroid/content/Context;[B)[B
...
.method private static c(Landroid/content/Context;)[B
    ...
    invoke-static {v2, v1}, Lcom/amap/api/col/ep;->a(Ljava/io/ByteArrayOutputStream;Ljava/lang/String;)V
...
.method private static d(Landroid/content/Context;)[B
    ...
    sget-object v0, Lcom/amap/api/col/eu;->g:Ljava/lang/String;

    const v1, 0x4b000

    invoke-static {p0, v0, v1}, Lcom/amap/api/col/gt;->a(Landroid/content/Context;Ljava/lang/String;I)[B
...
.method private static e(Landroid/content/Context;)Z
    ...
    sget-boolean v2, Lcom/amap/api/col/gs;->a:Z

    if-eqz v2, :cond_0

    sget-object v2, Lcom/amap/api/col/eu;->g:Ljava/lang/String;

    invoke-static {p0, v2}, Lcom/amap/api/col/gt;->a(Landroid/content/Context;Ljava/lang/String;)I
    ...
    invoke-static {p0, v2}, Lcom/amap/api/col/gt;->b(Landroid/content/Context;Ljava/lang/String;)J
    ...
    invoke-static {p0, v4, v5, v2}, Lcom/amap/api/col/gt;->a(Landroid/content/Context;JLjava/lang/String;)V

    const/4 v2, 0x0

    sput-boolean v2, Lcom/amap/api/col/gs;->a:Z
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
