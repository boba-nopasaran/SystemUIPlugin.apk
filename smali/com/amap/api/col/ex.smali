...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/amap/api/col/ex;->b:Z
...
.method protected constructor <init>(I)V
    ...
    invoke-direct {p0, p1}, Lcom/amap/api/col/fa;-><init>(I)V

    const/16 v0, 0xa

    new-array v0, v0, [Ljava/lang/String;

    iput-object v0, p0, Lcom/amap/api/col/ex;->c:[Ljava/lang/String;

    iput v1, p0, Lcom/amap/api/col/ex;->d:I

    iput-boolean v1, p0, Lcom/amap/api/col/ex;->e:Z

    iput v1, p0, Lcom/amap/api/col/ex;->f:I
...
.method private c(Ljava/lang/String;)V
    ...
    :try_start_0
    iget v0, p0, Lcom/amap/api/col/ex;->d:I
    ...
    iput v0, p0, Lcom/amap/api/col/ex;->d:I

    :cond_0
    iget-object v0, p0, Lcom/amap/api/col/ex;->c:[Ljava/lang/String;

    iget v1, p0, Lcom/amap/api/col/ex;->d:I
...
.method private e()Ljava/lang/String;
    ...
    :goto_1
    iget v2, p0, Lcom/amap/api/col/ex;->d:I

    if-ge v0, v2, :cond_2

    iget-object v2, p0, Lcom/amap/api/col/ex;->c:[Ljava/lang/String;
...
.method protected a(Ljava/util/List;)Ljava/lang/String;
    ...
    :try_start_1
    invoke-virtual {v2}, Lcom/amap/api/col/gd;->close()V
    :try_end_1
    ...
    sget-object v0, Lcom/amap/api/col/ge;->a:Ljava/nio/charset/Charset;

    invoke-direct {v2, v3, v0}, Lcom/amap/api/col/gd;-><init>(Ljava/io/InputStream;Ljava/nio/charset/Charset;)V
    :try_end_4
    ...
    :cond_7
    :goto_8
    iget-boolean v0, p0, Lcom/amap/api/col/ex;->e:Z

    if-eqz v0, :cond_10

    invoke-direct {p0}, Lcom/amap/api/col/ex;->e()Ljava/lang/String;
    ...
    :try_start_8
    invoke-direct {p0, v4}, Lcom/amap/api/col/ex;->c(Ljava/lang/String;)V

    iget v0, p0, Lcom/amap/api/col/ex;->f:I
    ...
    invoke-virtual {v0}, Lcom/amap/api/col/eo;->g()[Ljava/lang/String;

    move-result-object v7

    invoke-static {v7, v4}, Lcom/amap/api/col/ex;->b([Ljava/lang/String;Ljava/lang/String;)Z

    move-result v7

    iput-boolean v7, p0, Lcom/amap/api/col/ex;->e:Z

    iget-boolean v7, p0, Lcom/amap/api/col/ex;->e:Z

    if-eqz v7, :cond_9

    invoke-virtual {p0, v0}, Lcom/amap/api/col/ex;->a(Lcom/amap/api/col/eo;)V
    ...
    iput v0, p0, Lcom/amap/api/col/ex;->f:I
    :try_end_8
    ...
    :try_start_11
    invoke-virtual {v0}, Lcom/amap/api/col/gd;->close()V
    :try_end_11
...
.method protected a(Landroid/content/Context;)Z
    ...
    sget-boolean v2, Lcom/amap/api/col/ex;->b:Z

    if-eqz v2, :cond_2

    sput-boolean v1, Lcom/amap/api/col/ex;->b:Z
    ...
    :try_start_0
    new-instance v3, Lcom/amap/api/col/fn;

    invoke-direct {v3, p1}, Lcom/amap/api/col/fn;-><init>(Landroid/content/Context;)V

    invoke-virtual {v3}, Lcom/amap/api/col/fn;->a()Lcom/amap/api/col/fo;
    ...
    :cond_0
    invoke-virtual {v4}, Lcom/amap/api/col/fo;->c()Z
    ...
    invoke-virtual {v4, v1}, Lcom/amap/api/col/fo;->c(Z)V

    invoke-virtual {v3, v4}, Lcom/amap/api/col/fn;->a(Lcom/amap/api/col/fo;)V
