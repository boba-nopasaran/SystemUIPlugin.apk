...
# interfaces
.implements Lcom/amap/api/col/an;
...
.method public constructor <init>(Lcom/amap/api/mapcore/k;)V
    ...
    iput v0, p0, Lcom/amap/api/col/aj;->h:F

    const/high16 v0, -0x1000000

    iput v0, p0, Lcom/amap/api/col/aj;->i:I

    const/4 v0, 0x0

    iput v0, p0, Lcom/amap/api/col/aj;->j:F

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/amap/api/col/aj;->k:Z

    iput v1, p0, Lcom/amap/api/col/aj;->o:I

    iput-boolean v1, p0, Lcom/amap/api/col/aj;->p:Z

    iput-wide v2, p0, Lcom/amap/api/col/aj;->q:D

    iput-wide v2, p0, Lcom/amap/api/col/aj;->r:D

    iput-wide v2, p0, Lcom/amap/api/col/aj;->s:D

    iput-object p1, p0, Lcom/amap/api/col/aj;->m:Lcom/amap/api/mapcore/k;

    :try_start_0
    invoke-virtual {p0}, Lcom/amap/api/col/aj;->getId()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lcom/amap/api/col/aj;->l:Ljava/lang/String;
    :try_end_0
...
.method private a(DDDD)D
    ...
    iget-wide v2, p0, Lcom/amap/api/col/aj;->q:D
...
.method private a(Lcom/autonavi/ae/gmap/GLMapState;DDD)Lcom/autonavi/amap/mapcore/FPoint;
    ...
    iget-wide v4, p0, Lcom/amap/api/col/aj;->q:D
...
.method private e()Z
    ...
    iget-object v0, p0, Lcom/amap/api/col/aj;->e:Lcom/amap/api/maps/model/LatLng;

    iget-wide v0, v0, Lcom/amap/api/maps/model/LatLng;->latitude:D

    iget-object v2, p0, Lcom/amap/api/col/aj;->f:Lcom/amap/api/maps/model/LatLng;
    ...
    iget-object v4, p0, Lcom/amap/api/col/aj;->g:Lcom/amap/api/maps/model/LatLng;
    ...
    iget-object v2, p0, Lcom/amap/api/col/aj;->e:Lcom/amap/api/maps/model/LatLng;

    iget-wide v2, v2, Lcom/amap/api/maps/model/LatLng;->longitude:D

    iget-object v4, p0, Lcom/amap/api/col/aj;->f:Lcom/amap/api/maps/model/LatLng;
    ...
    iget-object v6, p0, Lcom/amap/api/col/aj;->g:Lcom/amap/api/maps/model/LatLng;
...
.method private f()Lcom/autonavi/amap/mapcore/DPoint;
    ...
    iget-object v3, v0, Lcom/amap/api/col/aj;->m:Lcom/amap/api/mapcore/k;

    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/amap/api/col/aj;->e:Lcom/amap/api/maps/model/LatLng;
    ...
    iget-object v9, v0, Lcom/amap/api/col/aj;->m:Lcom/amap/api/mapcore/k;

    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/amap/api/col/aj;->f:Lcom/amap/api/maps/model/LatLng;
    ...
    iget-object v15, v0, Lcom/amap/api/col/aj;->m:Lcom/amap/api/mapcore/k;

    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/amap/api/col/aj;->g:Lcom/amap/api/maps/model/LatLng;
    ...
    iput-wide v2, v0, Lcom/amap/api/col/aj;->q:D

    move-object/from16 v3, p0

    move-wide v8, v12

    invoke-direct/range {v3 .. v11}, Lcom/amap/api/col/aj;->a(DDDD)D

    move-result-wide v2

    move-object/from16 v0, p0

    iput-wide v2, v0, Lcom/amap/api/col/aj;->r:D
    ...
    iput-wide v2, v0, Lcom/amap/api/col/aj;->s:D

    move-object/from16 v0, p0

    iget-wide v2, v0, Lcom/amap/api/col/aj;->r:D

    move-object/from16 v0, p0

    iget-wide v8, v0, Lcom/amap/api/col/aj;->s:D
    ...
    iget-wide v2, v0, Lcom/amap/api/col/aj;->s:D
...
.method public a(Lcom/amap/api/maps/model/LatLng;)V
    ...
    iput-object p1, p0, Lcom/amap/api/col/aj;->e:Lcom/amap/api/maps/model/LatLng;
...
.method public b(Lcom/amap/api/maps/model/LatLng;)V
    ...
    iput-object p1, p0, Lcom/amap/api/col/aj;->f:Lcom/amap/api/maps/model/LatLng;
...
.method public b()Z
    ...
    iget-object v0, p0, Lcom/amap/api/col/aj;->f:Lcom/amap/api/maps/model/LatLng;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/amap/api/col/aj;->g:Lcom/amap/api/maps/model/LatLng;

    if-eqz v0, :cond_0

    iget-boolean v0, p0, Lcom/amap/api/col/aj;->k:Z
    ...
    :try_start_0
    iput-boolean v0, p0, Lcom/amap/api/col/aj;->p:Z

    iget-object v0, p0, Lcom/amap/api/col/aj;->m:Lcom/amap/api/mapcore/k;

    invoke-interface {v0}, Lcom/amap/api/mapcore/k;->b()Lcom/autonavi/ae/gmap/GLMapState;

    move-result-object v9

    invoke-direct {p0}, Lcom/amap/api/col/aj;->e()Z
    ...
    iput-object v0, p0, Lcom/amap/api/col/aj;->n:[F

    new-instance v6, Lcom/autonavi/amap/mapcore/FPoint;

    invoke-direct {v6}, Lcom/autonavi/amap/mapcore/FPoint;-><init>()V

    iget-object v1, p0, Lcom/amap/api/col/aj;->m:Lcom/amap/api/mapcore/k;
    ...
    iget-object v1, p0, Lcom/amap/api/col/aj;->n:[F
    ...
    iput v0, p0, Lcom/amap/api/col/aj;->o:I
    ...
    :cond_3
    invoke-direct {p0}, Lcom/amap/api/col/aj;->f()Lcom/autonavi/amap/mapcore/DPoint;

    move-result-object v10

    iget-wide v0, p0, Lcom/amap/api/col/aj;->s:D

    iget-wide v2, p0, Lcom/amap/api/col/aj;->r:D
    ...
    :goto_3
    iget-wide v0, p0, Lcom/amap/api/col/aj;->r:D
    ...
    invoke-direct/range {v0 .. v7}, Lcom/amap/api/col/aj;->a(Lcom/autonavi/ae/gmap/GLMapState;DDD)Lcom/autonavi/amap/mapcore/FPoint;

    move-result-object v0

    aput-object v0, v14, v8

    iget-object v0, p0, Lcom/amap/api/col/aj;->n:[F
...
.method public c()V
    ...
    :cond_1
    invoke-virtual {p0}, Lcom/amap/api/col/aj;->b()Z

    iget-object v0, p0, Lcom/amap/api/col/aj;->n:[F

    if-eqz v0, :cond_2

    iget v0, p0, Lcom/amap/api/col/aj;->o:I
    ...
    iget v1, p0, Lcom/amap/api/col/aj;->h:F
    ...
    iget-object v3, p0, Lcom/amap/api/col/aj;->m:Lcom/amap/api/mapcore/k;

    invoke-interface {v3}, Lcom/amap/api/mapcore/k;->c()I

    move-result v3

    iget v4, p0, Lcom/amap/api/col/aj;->b:F

    iget v5, p0, Lcom/amap/api/col/aj;->c:F

    iget v6, p0, Lcom/amap/api/col/aj;->d:F

    iget v7, p0, Lcom/amap/api/col/aj;->a:F

    const/4 v8, 0x0

    iget-object v11, p0, Lcom/amap/api/col/aj;->m:Lcom/amap/api/mapcore/k;
    ...
    :cond_2
    iput-boolean v10, p0, Lcom/amap/api/col/aj;->p:Z
...
.method public c(Lcom/amap/api/maps/model/LatLng;)V
    ...
    iput-object p1, p0, Lcom/amap/api/col/aj;->g:Lcom/amap/api/maps/model/LatLng;
...
.method public d()Z
    ...
    iget-boolean v0, p0, Lcom/amap/api/col/aj;->p:Z
...
.method public destroy()V
    ...
    :try_start_0
    iput-object v0, p0, Lcom/amap/api/col/aj;->e:Lcom/amap/api/maps/model/LatLng;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/amap/api/col/aj;->f:Lcom/amap/api/maps/model/LatLng;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/amap/api/col/aj;->g:Lcom/amap/api/maps/model/LatLng;
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getId()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/amap/api/col/aj;->l:Ljava/lang/String;
...
.method public getStrokeColor()I
    ...
    iget v0, p0, Lcom/amap/api/col/aj;->i:I
...
.method public getStrokeWidth()F
    ...
    iget v0, p0, Lcom/amap/api/col/aj;->h:F
...
.method public getZIndex()F
    ...
    iget v0, p0, Lcom/amap/api/col/aj;->j:F
...
.method public setStrokeColor(I)V
    ...
    iput p1, p0, Lcom/amap/api/col/aj;->i:I
    ...
    iput v0, p0, Lcom/amap/api/col/aj;->a:F
    ...
    iput v0, p0, Lcom/amap/api/col/aj;->b:F
    ...
    iput v0, p0, Lcom/amap/api/col/aj;->c:F
    ...
    iput v0, p0, Lcom/amap/api/col/aj;->d:F
...
.method public setStrokeWidth(F)V
    ...
    iput p1, p0, Lcom/amap/api/col/aj;->h:F
...
.method public setVisible(Z)V
    ...
    iput-boolean p1, p0, Lcom/amap/api/col/aj;->k:Z
...
.method public setZIndex(F)V
    ...
    iput p1, p0, Lcom/amap/api/col/aj;->j:F
