...
.method private constructor <init>(Lcom/amap/api/mapcore/h;)V
    ...
    iput-object v0, p0, Lcom/amap/api/mapcore/h$b;->b:Lcom/autonavi/ae/gmap/gesture/EAMapPlatformGestureInfo;
...
.method public onHove(Lcom/autonavi/ae/gmap/gesture/HoverGestureDetector;)Z
    ...
    iget-object v2, p0, Lcom/amap/api/mapcore/h$b;->b:Lcom/autonavi/ae/gmap/gesture/EAMapPlatformGestureInfo;
    ...
    invoke-interface {v2}, Lcom/amap/api/mapcore/n;->isTiltGesturesEnabled()Z
    :try_end_0
    ...
    iget-object v3, p0, Lcom/amap/api/mapcore/h$b;->b:Lcom/autonavi/ae/gmap/gesture/EAMapPlatformGestureInfo;
    ...
    invoke-interface {v3, v2}, Lcom/amap/api/mapcore/k;->d(I)Z
    ...
    invoke-static {v3}, Lcom/amap/api/mapcore/h;->c(Lcom/amap/api/mapcore/h;)I
    ...
    iget-object v5, p0, Lcom/amap/api/mapcore/h$b;->a:Lcom/amap/api/mapcore/h;

    invoke-static {v5}, Lcom/amap/api/mapcore/h;->i(Lcom/amap/api/mapcore/h;)Z
    ...
    invoke-static {v1}, Lcom/amap/api/mapcore/h;->i(Lcom/amap/api/mapcore/h;)Z
    ...
    new-instance v4, Lcom/autonavi/amap/mapcore/message/HoverGestureMapMessage;

    const/16 v5, 0x65

    invoke-direct {v4, v5, v1}, Lcom/autonavi/amap/mapcore/message/HoverGestureMapMessage;-><init>(IF)V
...
.method public onHoveBegin(Lcom/autonavi/ae/gmap/gesture/HoverGestureDetector;)Z
    ...
    new-instance v3, Lcom/autonavi/amap/mapcore/message/HoverGestureMapMessage;
    ...
    invoke-interface {v5, v2}, Lcom/amap/api/mapcore/k;->p(I)F

    move-result v5

    invoke-direct {v3, v4, v5}, Lcom/autonavi/amap/mapcore/message/HoverGestureMapMessage;-><init>(IF)V

    invoke-interface {v1, v2, v3}, Lcom/amap/api/mapcore/k;->a(ILcom/autonavi/amap/mapcore/message/GestureMapMessage;)V
...
.method public onHoveEnd(Lcom/autonavi/ae/gmap/gesture/HoverGestureDetector;)V
    ...
    iget-object v0, p0, Lcom/amap/api/mapcore/h$b;->b:Lcom/autonavi/ae/gmap/gesture/EAMapPlatformGestureInfo;
    ...
    invoke-interface {v0}, Lcom/amap/api/mapcore/n;->isTiltGesturesEnabled()Z
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget-object v1, p0, Lcom/amap/api/mapcore/h$b;->b:Lcom/autonavi/ae/gmap/gesture/EAMapPlatformGestureInfo;
    ...
    invoke-interface {v1, v0}, Lcom/amap/api/mapcore/k;->d(I)Z
    ...
    invoke-interface {v1, v0}, Lcom/amap/api/mapcore/k;->p(I)F
    ...
    invoke-static {v1}, Lcom/amap/api/mapcore/h;->a(Lcom/amap/api/mapcore/h;)I
    ...
    invoke-static {v1, v4}, Lcom/amap/api/mapcore/h;->b(Lcom/amap/api/mapcore/h;Z)Z

    iget-object v1, p0, Lcom/amap/api/mapcore/h$b;->a:Lcom/amap/api/mapcore/h;

    iget-object v1, v1, Lcom/amap/api/mapcore/h;->a:Lcom/amap/api/mapcore/k;

    new-instance v2, Lcom/autonavi/amap/mapcore/message/HoverGestureMapMessage;
    ...
    invoke-interface {v4, v0}, Lcom/amap/api/mapcore/k;->p(I)F

    move-result v4

    invoke-direct {v2, v3, v4}, Lcom/autonavi/amap/mapcore/message/HoverGestureMapMessage;-><init>(IF)V
