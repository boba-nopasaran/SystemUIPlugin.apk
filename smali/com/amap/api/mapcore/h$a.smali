...
.method private constructor <init>(Lcom/amap/api/mapcore/h;)V
    ...
    iput-object v0, p0, Lcom/amap/api/mapcore/h$a;->e:Lcom/autonavi/ae/gmap/gesture/EAMapPlatformGestureInfo;
...
.method public onDoubleTap(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, v0, Lcom/amap/api/mapcore/h;->c:Landroid/view/GestureDetector;
    ...
    iget-object v0, v0, Lcom/amap/api/mapcore/h;->d:Lcom/amap/api/maps/model/AMapGestureListener;
...
.method public onDoubleTapEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-interface {v2}, Lcom/amap/api/mapcore/k;->g()Lcom/amap/api/mapcore/n;

    move-result-object v2

    invoke-interface {v2}, Lcom/amap/api/mapcore/n;->isZoomGesturesEnabled()Z
    :try_end_0
    ...
    invoke-static {v2, v4, v5}, Lcom/amap/api/col/ew;->b(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v2, p0, Lcom/amap/api/mapcore/h$a;->e:Lcom/autonavi/ae/gmap/gesture/EAMapPlatformGestureInfo;
    ...
    iget-object v3, p0, Lcom/amap/api/mapcore/h$a;->e:Lcom/autonavi/ae/gmap/gesture/EAMapPlatformGestureInfo;

    invoke-interface {v2, v3}, Lcom/amap/api/mapcore/k;->a(Lcom/autonavi/ae/gmap/gesture/EAMapPlatformGestureInfo;)I
    ...
    iput v3, p0, Lcom/amap/api/mapcore/h$a;->a:F

    iget-object v3, p0, Lcom/amap/api/mapcore/h$a;->c:Lcom/amap/api/mapcore/h;
    ...
    invoke-direct {v4, v5, v8, v1, v1}, Lcom/autonavi/amap/mapcore/message/ScaleGestureMapMessage;-><init>(IFII)V

    invoke-interface {v3, v2, v4}, Lcom/amap/api/mapcore/k;->a(ILcom/autonavi/amap/mapcore/message/GestureMapMessage;)V
    ...
    iget-object v4, p0, Lcom/amap/api/mapcore/h$a;->e:Lcom/autonavi/ae/gmap/gesture/EAMapPlatformGestureInfo;

    invoke-interface {v3, v4}, Lcom/amap/api/mapcore/k;->a(Lcom/autonavi/ae/gmap/gesture/EAMapPlatformGestureInfo;)I
    ...
    iget-object v5, p0, Lcom/amap/api/mapcore/h$a;->c:Lcom/amap/api/mapcore/h;

    iget-object v5, v5, Lcom/amap/api/mapcore/h;->a:Lcom/amap/api/mapcore/k;

    invoke-interface {v5}, Lcom/amap/api/mapcore/k;->getMapHeight()I
    ...
    new-instance v5, Lcom/autonavi/amap/mapcore/message/ScaleGestureMapMessage;

    const/16 v6, 0x65

    invoke-direct {v5, v6, v4, v1, v1}, Lcom/autonavi/amap/mapcore/message/ScaleGestureMapMessage;-><init>(IFII)V

    invoke-interface {v2, v3, v5}, Lcom/amap/api/mapcore/k;->a(ILcom/autonavi/amap/mapcore/message/GestureMapMessage;)V
    ...
    invoke-interface {v2, v4}, Lcom/amap/api/mapcore/k;->a(Lcom/autonavi/ae/gmap/gesture/EAMapPlatformGestureInfo;)I

    move-result v2

    iget-object v4, p0, Lcom/amap/api/mapcore/h$a;->c:Lcom/amap/api/mapcore/h;

    iget-object v4, v4, Lcom/amap/api/mapcore/h;->c:Landroid/view/GestureDetector;
    ...
    invoke-direct {v5, v6, v8, v1, v1}, Lcom/autonavi/amap/mapcore/message/ScaleGestureMapMessage;-><init>(IFII)V

    invoke-interface {v4, v2, v5}, Lcom/amap/api/mapcore/k;->a(ILcom/autonavi/amap/mapcore/message/GestureMapMessage;)V
    ...
    invoke-interface {v3, v2, v4}, Lcom/amap/api/mapcore/k;->a(II)V

    invoke-static {}, Landroid/os/SystemClock;->uptimeMillis()J

    move-result-wide v4

    iget-wide v6, p0, Lcom/amap/api/mapcore/h$a;->b:J

    sub-long/2addr v4, v6

    iget-object v3, p0, Lcom/amap/api/mapcore/h$a;->c:Lcom/amap/api/mapcore/h;

    invoke-static {v3}, Lcom/amap/api/mapcore/h;->f(Lcom/amap/api/mapcore/h;)Z
    ...
    invoke-interface {v0, v2, p1}, Lcom/amap/api/mapcore/k;->b(ILandroid/view/MotionEvent;)Z
...
.method public onFling(Landroid/view/MotionEvent;Landroid/view/MotionEvent;FF)Z
    ...
    invoke-static {v0}, Lcom/amap/api/mapcore/h;->a(Lcom/amap/api/mapcore/h;)I
    ...
    invoke-static {v0}, Lcom/amap/api/mapcore/h;->d(Lcom/amap/api/mapcore/h;)Z

    move-result v0

    if-nez v0, :cond_1

    iget-object v0, p0, Lcom/amap/api/mapcore/h$a;->e:Lcom/autonavi/ae/gmap/gesture/EAMapPlatformGestureInfo;
    ...
    iget-object v1, p0, Lcom/amap/api/mapcore/h$a;->e:Lcom/autonavi/ae/gmap/gesture/EAMapPlatformGestureInfo;

    invoke-interface {v0, v1}, Lcom/amap/api/mapcore/k;->a(Lcom/autonavi/ae/gmap/gesture/EAMapPlatformGestureInfo;)I

    move-result v0

    iget-object v1, p0, Lcom/amap/api/mapcore/h$a;->c:Lcom/amap/api/mapcore/h;

    iget-object v1, v1, Lcom/amap/api/mapcore/h;->a:Lcom/amap/api/mapcore/k;

    invoke-interface {v1}, Lcom/amap/api/mapcore/k;->onFling()V

    iget-object v1, p0, Lcom/amap/api/mapcore/h$a;->c:Lcom/amap/api/mapcore/h;

    iget-object v1, v1, Lcom/amap/api/mapcore/h;->a:Lcom/amap/api/mapcore/k;

    invoke-interface {v1}, Lcom/amap/api/mapcore/k;->a()Lcom/autonavi/ae/gmap/GLMapEngine;
...
.method public onLongPress(Landroid/view/MotionEvent;)V
    ...
    invoke-interface {v1, v0, p1}, Lcom/amap/api/mapcore/k;->a(ILandroid/view/MotionEvent;)V
...
.method public onShowPress(Landroid/view/MotionEvent;)V
    ...
    invoke-virtual {v1, v0, v4}, Lcom/autonavi/ae/gmap/GLMapEngine;->clearAnimations(IZ)V
...
.method public onSingleTapConfirmed(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {v1}, Lcom/amap/api/mapcore/h;->e(Lcom/amap/api/mapcore/h;)I
    ...
    iget-object v1, v1, Lcom/amap/api/mapcore/h;->d:Lcom/amap/api/maps/model/AMapGestureListener;
    ...
    invoke-interface {v1, v0, p1}, Lcom/amap/api/mapcore/k;->c(ILandroid/view/MotionEvent;)Z
