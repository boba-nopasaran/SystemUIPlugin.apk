...
.method public constructor <init>(Lcom/amap/api/mapcore/k;)V
    ...
    iput-object p1, p0, Lcom/amap/api/mapcore/s;->a:Lcom/amap/api/mapcore/k;
...
.method public fromBoundsToTile(Lcom/amap/api/maps/model/LatLngBounds;II)Lcom/amap/api/maps/model/TileProjection;
    ...
    iget-object v1, p0, Lcom/amap/api/mapcore/s;->a:Lcom/amap/api/mapcore/k;
    ...
    iget-object v7, p0, Lcom/amap/api/mapcore/s;->a:Lcom/amap/api/mapcore/k;
...
.method public fromScreenLocation(Landroid/graphics/Point;)Lcom/amap/api/maps/model/LatLng;
    ...
    iget-object v0, p0, Lcom/amap/api/mapcore/s;->a:Lcom/amap/api/mapcore/k;
...
.method public getCameraInfo()Lcom/amap/api/maps/model/AMapCameraInfo;
    ...
    invoke-interface {v0}, Lcom/amap/api/mapcore/k;->getCamerInfo()Lcom/amap/api/maps/model/AMapCameraInfo;
...
.method public getVisibleRegion()Lcom/amap/api/maps/model/VisibleRegion;
    ...
    invoke-interface {v0}, Lcom/amap/api/mapcore/k;->getMapWidth()I

    move-result v0

    iget-object v1, p0, Lcom/amap/api/mapcore/s;->a:Lcom/amap/api/mapcore/k;

    invoke-interface {v1}, Lcom/amap/api/mapcore/k;->getMapHeight()I
    ...
    invoke-virtual {p0, v1}, Lcom/amap/api/mapcore/s;->fromScreenLocation(Landroid/graphics/Point;)Lcom/amap/api/maps/model/LatLng;
    ...
    invoke-virtual {p0, v5}, Lcom/amap/api/mapcore/s;->fromScreenLocation(Landroid/graphics/Point;)Lcom/amap/api/maps/model/LatLng;
