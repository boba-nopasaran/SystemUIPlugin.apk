...
.method static constructor <clinit>()V
    ...
    sput-object v0, Llibcore/io/DiskLruCache;->UTF_8:Ljava/nio/charset/Charset;
...
.method private constructor <init>(Ljava/io/File;IIJ)V
    ...
    iput-object v1, p0, Llibcore/io/DiskLruCache;->executorService:Ljava/util/concurrent/ExecutorService;
...
.method static synthetic access$1800()Ljava/nio/charset/Charset;
    ...
    sget-object v0, Llibcore/io/DiskLruCache;->UTF_8:Ljava/nio/charset/Charset;

    return-object v0
.end method

.method static synthetic access$1900(Llibcore/io/DiskLruCache;Llibcore/io/DiskLruCache$Editor;Z)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method static synthetic access$2100(Llibcore/io/DiskLruCache;)I
    .locals 1
...
.method public static deleteContents(Ljava/io/File;)V
    ...
    invoke-static {v1}, Llibcore/io/DiskLruCache;->deleteContents(Ljava/io/File;)V
...
.method private static inputStreamToString(Ljava/io/InputStream;)Ljava/lang/String;
    ...
    sget-object v1, Llibcore/io/DiskLruCache;->UTF_8:Ljava/nio/charset/Charset;

    invoke-direct {v0, p0, v1}, Ljava/io/InputStreamReader;-><init>(Ljava/io/InputStream;Ljava/nio/charset/Charset;)V

    invoke-static {v0}, Llibcore/io/DiskLruCache;->readFully(Ljava/io/Reader;)Ljava/lang/String;
...
.method private processJournal()V
    ...
    iget-wide v4, p0, Llibcore/io/DiskLruCache;->size:J
...
.method private readJournal()V
    ...
    :try_start_0
    invoke-static {v3}, Llibcore/io/DiskLruCache;->readAsciiLine(Ljava/io/InputStream;)Ljava/lang/String;
    ...
    invoke-static {v3}, Llibcore/io/DiskLruCache;->closeQuietly(Ljava/io/Closeable;)V
...
.method private readJournalLine(Ljava/lang/String;)V
    ...
    invoke-static {v2, v5, v3}, Llibcore/io/DiskLruCache;->copyOfRange([Ljava/lang/Object;II)[Ljava/lang/Object;
...
.method private trimToSize()V
    ...
    :goto_0
    iget-wide v2, p0, Llibcore/io/DiskLruCache;->size:J

    iget-wide v4, p0, Llibcore/io/DiskLruCache;->maxSize:J
...
.method public delete()V
    ...
    invoke-static {v0}, Llibcore/io/DiskLruCache;->deleteContents(Ljava/io/File;)V
...
.method public declared-synchronized get(Ljava/lang/String;)Llibcore/io/DiskLruCache$Snapshot;
    ...
    iget v2, p0, Llibcore/io/DiskLruCache;->valueCount:I
    ...
    iput v1, p0, Llibcore/io/DiskLruCache;->redundantOpCount:I

    iget-object v1, p0, Llibcore/io/DiskLruCache;->journalWriter:Ljava/io/Writer;
    ...
    iget-object v1, p0, Llibcore/io/DiskLruCache;->executorService:Ljava/util/concurrent/ExecutorService;

    iget-object v2, p0, Llibcore/io/DiskLruCache;->cleanupCallable:Ljava/util/concurrent/Callable;

    invoke-interface {v1, v2}, Ljava/util/concurrent/ExecutorService;->submit(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Future;

    :cond_3
    new-instance v1, Llibcore/io/DiskLruCache$Snapshot;
    ...
    invoke-direct/range {v1 .. v7}, Llibcore/io/DiskLruCache$Snapshot;-><init>(Llibcore/io/DiskLruCache;Ljava/lang/String;J[Ljava/io/InputStream;Llibcore/io/DiskLruCache$1;)V
    :try_end_3
